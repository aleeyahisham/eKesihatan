    ...
    <div class="landing-hero-slider" id="landing-hero-slider" aria-roledescription="carousel" aria-label="eKesihatan highlights" aria-live="polite">
        <div class="landing-hero-slider__track">
            <figure class="landing-hero-slider__slide">
                <img src="<?php echo e(asset('images/intern.jpg')); ?>" alt="Interns at Unit Kesihatan UiTM">
            </figure>
            <figure class="landing-hero-slider__slide">
                <img src="<?php echo e(asset('images/inside.jpg')); ?>" alt="Inside the clinic reception area">
            </figure>
            <figure class="landing-hero-slider__slide">
                <img src="<?php echo e(asset('images/1000langkah.jpg')); ?>" alt="1000 langkah healthy activity event">
            </figure>
            <figure class="landing-hero-slider__slide">
                <img src="<?php echo e(asset('images/santuniKomuniti.jpg')); ?>" alt="Santuni komuniti health outreach session">
            </figure>
        </div>
    ...
    <div class="landing-widget-grid">
        <section class="landing-widget landing-widget--notices" aria-labelledby="clinic-notices-title">
            <div class="landing-widget__header">
                ...
                <span class="landing-widget__count" aria-label="<?php echo e($bulletins->count()); ?> notices"><?php echo e($bulletins->count()); ?></span>
            </div>
            ...
            <div class="notice-accordion" data-notice-accordion>
                <?php $__empty_1 = true; $__currentLoopData = $bulletins; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bulletin): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    ?>
                    <article class="notice-accordion__item" id="bulletin-<?php echo e($bulletin->id); ?>">
                        <button type="button" class="notice-accordion__trigger" aria-expanded="false" aria-controls="<?php echo e($accordionId); ?>">
                            ...
                            <span class="notice-accordion__summary">
                                <strong><?php echo e($bulletin->title); ?></strong>
                                <span class="notice-accordion__meta">
                                    <?php if($bulletin->event_date): ?>
                                        <span><svg viewBox="0 0 24 24" aria-hidden="true"><rect x="3" y="5" width="18" height="16" rx="2"/><path d="M16 3v4M8 3v4M3 10h18"/></svg><?php echo e($bulletin->event_date->format('d M Y')); ?></span>
                                    <?php endif; ?>
                                    <?php if($bulletin->event_time): ?>
                                        <span><svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="9"/><path d="M12 7v5l3 2"/></svg><?php echo e($bulletin->event_time); ?></span>
                                    <?php endif; ?>
                                    <?php if($bulletin->location): ?>
                                        <span><svg viewBox="0 0 24 24" aria-hidden="true"><path d="M20 10c0 5-8 11-8 11S4 15 4 10a8 8 0 1 1 16 0Z"/><circle cx="12" cy="10" r="2.5"/></svg><?php echo e($bulletin->location); ?></span>
                                    <?php endif; ?>
                                </span>
                            </span>
                        ...
                        <div id="<?php echo e($accordionId); ?>" class="notice-accordion__panel" hidden>
                            <div class="notice-accordion__content">
                                <?php if($bulletin->summary): ?><p class="notice-accordion__lead"><?php echo e($bulletin->summary); ?></p><?php endif; ?>
                                <?php if($bulletin->event_date || $bulletin->event_time || $bulletin->location): ?>
                                    <dl class="notice-detail-grid">
                                        <?php if($bulletin->event_date): ?><div><dt data-i18n="Date">Date</dt><dd><?php echo e($bulletin->event_date->format('d M Y (l)')); ?></dd></div><?php endif; ?>
                                        <?php if($bulletin->event_time): ?><div><dt data-i18n="Time">Time</dt><dd><?php echo e($bulletin->event_time); ?></dd></div><?php endif; ?>
                                        <?php if($bulletin->location): ?><div><dt data-i18n="Location">Location</dt><dd><?php echo e($bulletin->location); ?></dd></div><?php endif; ?>
                                    </dl>
                                <?php endif; ?>
                                <?php if($bulletin->details): ?><p><?php echo e($bulletin->details); ?></p><?php endif; ?>
                                <?php if($posterUrl): ?>
                                    <div class="bulletin-actions">
                                        <a class="landing-action-button" href="<?php echo e($posterUrl); ?>" target="_blank" rel="noopener noreferrer">View Full Poster</a>
                                    </div>
                                <?php endif; ?>
                            </div>
                        </div>
        ...
        <section class="landing-widget landing-widget--downloads" aria-labelledby="forms-downloads-title">
            <div class="landing-widget__header">
                ...
                <span class="landing-widget__count" aria-label="<?php echo e($downloadableForms->count()); ?> forms"><?php echo e($downloadableForms->count()); ?></span>
            </div>
            ...
            <div class="download-card-grid">
                <?php $__empty_1 = true; $__currentLoopData = $downloadableForms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $downloadableForm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <?php
                    ...
                    <article class="download-card">
                        ...
                        <div class="download-card__body"><div class="download-card__topline"><span class="download-card__format"><?php echo e($fileExtension); ?></span><span><?php echo e($fileSizeLabel); ?></span></div><h4><?php echo e($downloadableForm->title); ?></h4><?php if($downloadableForm->description): ?><p><?php echo e($downloadableForm->description); ?></p><?php endif; ?></div>
                        <?php if($fileExists): ?>
                            <a class="download-card__action" href="<?php echo e(asset($relativeFilePath)); ?>" download="<?php echo e($downloadFilename); ?>"><span data-i18n="Download">Download</span><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true"><path d="M12 3v12m0 0 4-4m-4 4-4-4"/><path d="M5 20h14"/></svg></a>
                        <?php else: ?>
    ...
    <div class="landing-connect__grid">
        ...
        >
            <div class="connect-card__media">
                <img src="<?php echo e(asset($facebookPreview)); ?>" alt="Facebook page preview for Unit Kesihatan UiTM Perlis" loading="lazy">
            </div>
        ...
        >
            <div class="connect-card__media">
                <img src="<?php echo e(asset($instagramPreview)); ?>" alt="Instagram page preview for Unit Kesihatan UiTM Perlis" loading="lazy">
            </div>
        ...
        >
            <div class="connect-card__media">
                <img src="<?php echo e(asset($tiktokPreview)); ?>" alt="Tiktok page preview for New Health UiTM Perlis" loading="lazy">
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ekesihat/ekesihatan/resources/views/landing.blade.php ENDPATH**/ ?>