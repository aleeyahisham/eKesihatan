...
<head>
    ...
    ?>
    <link rel="icon" type="<?php echo e($faviconType); ?>" href="<?php echo e($faviconUrl); ?>" sizes="32x32">
    <link rel="icon" type="<?php echo e($faviconType); ?>" href="<?php echo e($faviconUrl); ?>" sizes="192x192">
    <link rel="shortcut icon" href="<?php echo e($faviconUrl); ?>">
    <link rel="apple-touch-icon" href="<?php echo e($faviconUrl); ?>">
    <script>
        (function () {
            const source = <?php echo json_encode($faviconUrl, 15, 512) ?>;
    ...
    <link rel="stylesheet"
          href="<?php echo e(asset('css/app.css')); ?>?v=<?php echo e($publicCssVersion); ?>">
...
?>
<body id="top" class="<?php echo e(implode(' ', $bodyClasses)); ?>">
    ...
    <header>
        <div class="brand">
            <?php if($headerLogoPath): ?>
                <img
                    class="brand-logo"
                    src="<?php echo e(asset($headerLogoPath)); ?>"
                    alt="Unit Kesihatan UiTM Perlis logo"
                    width="80"
                    height="80"
                    loading="lazy"
                    onerror="this.onerror=null;this.src='<?php echo e(asset('images/eksa.png')); ?>';"
                >
            <?php endif; ?>
            <div class="brand-text">
                <h1><a href="<?php echo e(route('landing')); ?>">eKesihatan</a></h1>
    ...
    <div class="app-shell">
        <?php if(auth()->guard()->check()): ?>
            <?php if (! (request()->routeIs('landing', 'login', 'staff.login', 'register'))): ?>
            <aside class="sidebar <?php echo e(auth()->user()->isPatient() ? 'sidebar--patient' : ''); ?>">
                ...
                <nav class="sidebar-nav">
                    <div class="sidebar-menu">
                        <?php if(auth()->user()->isAdmin()): ?>
                            ...
                            <a href="<?php echo e(route('admin.bulletins.index')); ?>">
                            ...
                            <a href="<?php echo e(route('staff.patients.index')); ?>">
                        ...
                        <?php elseif(auth()->user()->isDoctor()): ?>
                            ...
                            <a href="<?php echo e(route('doctor.appointments.index')); ?>">
                                <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M8 3v4M16 3v4M4 10h16"/></svg></span>
                            ...
                            >
                                ...
                                <?php if($doctorUnreadNotifications->isNotEmpty()): ?>
                                    <span
                                        class="sidebar-notification-badge"
                                        aria-label="<?php echo e($doctorUnreadNotifications->count()); ?> unread notifications"
                                    >
                                        <?php echo e($doctorUnreadNotifications->count() > 99 ? '99+' : $doctorUnreadNotifications->count()); ?>
                        ...
                        <?php else: ?>
                            ...
                            <a href="<?php echo e(route('patient.services.index')); ?>">
                                <span class="icon" aria-hidden="true"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M4 7a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2z"/><path d="M8 6V4m8 2V4m-8 6h8"/></svg></span>
                                <span data-i18n="Health Services">Health Services</span>
                            </a>
        ...
        <?php if(auth()->user()->isDoctor()): ?>
            ...
            >
                ...
                <div class="doctor-notification-drawer__summary">
                    <span><?php echo e($doctorUnreadNotifications->count()); ?> unread</span>
                </div>

                <div class="doctor-notification-drawer__body">
                    <?php $__empty_1 = true; $__currentLoopData = $doctorUnreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <?php
                        ...
                        <article class="drawer-notification-card">
                            <div class="drawer-notification-card__top">
                                ...
                                <div>
                                    <h3><?php echo e($notificationData['title'] ?? 'Appointment Reassigned'); ?></h3>
                                    <time datetime="<?php echo e($notification->created_at->toIso8601String()); ?>">
                            ...
                            <p class="drawer-notification-card__message">
                                <?php echo e($notificationData['message'] ?? 'A new appointment has been assigned to your schedule.'); ?>
                            ...
                            <dl class="drawer-notification-details">
                                <div>
                                    <dt>Patient</dt>
                                    <dd><?php echo e($notificationData['patient_name'] ?? 'Patient'); ?></dd>
                                </div>

                                <div>
                                    <dt>Service</dt>
                                    <dd><?php echo e($notificationData['service_name'] ?? 'General Consultation'); ?></dd>
                                </div>

                                <div>
                                    <dt>Previous Doctor</dt>
                                    <dd><?php echo e($notificationData['previous_doctor'] ?? '-'); ?></dd>
                                </div>

                                <div>
                                    <dt>New Schedule</dt>
                                    <dd><?php echo e($notificationData['new_schedule'] ?? $notificationData['scheduled_at'] ?? '-'); ?></dd>
                                </div>

                                <div class="drawer-notification-details__wide">
                                    <dt>Reason</dt>
                                    <dd><?php echo e($notificationData['reason'] ?? 'Emergency schedule change'); ?></dd>
                                </div>
                            </dl>

                            <div class="drawer-notification-card__actions">
                                <?php if($appointmentUrl): ?>
                                    <a class="drawer-notification-primary" href="<?php echo e($appointmentUrl); ?>">
                                        Review Appointment
                                    </a>
                                <?php endif; ?>

                                <form method="POST" action="<?php echo e(route('doctor.notifications.read', $notification->id)); ?>">
                                    <?php echo csrf_field(); ?>
    ...
    <?php if(request()->routeIs('landing')): ?>
        <style>
            .brand {
                display: flex;
                align-items: center;
...
</html><?php /**PATH /home/ekesihat/ekesihatan/resources/views/layouts/app.blade.php ENDPATH**/ ?>